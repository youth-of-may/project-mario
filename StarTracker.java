...
public class StarTracker implements Objects
{
    ...
    StarTrackAnimation starTrackAnimation;

    public StarTracker(int x, int y, Player player) throws IOException
    {
        this.x = x;
        this.y = y;
        this.player = player;
        ...
        width = 30;
        height = 30;
        starTrackAnimation = new StarTrackAnimation();
        starTrackAnimation.start();
    ...
    public class StarTrackAnimation extends Thread
    {
        @Override
        public void run()
        {
